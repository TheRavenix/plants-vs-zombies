...
export interface Snowpea extends ShooterPlant {
  readonly type: PlantType.Snowpea;
}

type Options = ShooterPlantOptions;

const TYPE = PlantType.Snowpea as const;
const HEALTH = 300;
const SUNCOST = 175;
...
const SPRITE_PATH = "./plants/pea/snowpea/Snowpea.png";
...
export function createSnowpea(options: Options): Snowpea {
